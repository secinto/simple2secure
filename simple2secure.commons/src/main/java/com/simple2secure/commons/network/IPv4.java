...
public class IPv4 {
	...
	public IPv4(String symbolicIP, String netmask) throws NumberFormatException {
		...
		/*
		 * see if there are zeroes inside netmask, like: 1111111101111 This is illegal, throw exception if encountered. Netmask should always
		 * have only ones, then only zeroes, like: 11111111110000
		 */
	...
	public boolean contains(IPv4 child) {
		...
		if ((subnetID & netmaskNumeric) == (baseIPnumeric & netmaskNumeric)) {

			if ((netmaskNumeric < subnetMask) == true && baseIPnumeric <= subnetID) {
