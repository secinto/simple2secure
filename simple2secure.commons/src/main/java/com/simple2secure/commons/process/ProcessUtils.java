...
public class ProcessUtils {
	 ...
	 * {@link ProcessBuilder}. The input, output and error streams a wrapped in a
	 * StreamGobbler. The {@link Process} and the {@link ProcessStreamObservable}
	 * are returned as members of the {@link ProcessContainer}. Call
	 * {@link ProcessContainer#startObserving()} to allow consumption of the output
	 * from the process which is provided to the input and error stream via running
	 * an explicit thread for this using
	 * {@link Executors#newSingleThreadExecutor()}.
	 *
	 * @param executable The string which should be used to start a process via
	 *                   ProcessBuilder.
	 * @return The {@link ProcessContainer} which wraps the relevant streams and
	 *         processes.
	 */
	 ...
	 * from the process which is provided to the input and error stream via running
	 * an explicit thread for this using
	 * {@link Executors#newSingleThreadExecutor()}. The a map with environment
	 * variables is provided, it is applied to the created {@link ProcessBuilder} as
	 * environment settings. If the cleanEnv is set to true all existing environment
	 * variables from the system are cleared upfront.
	 *
	 * @param environment      The map with the environment variables which should
	 *                         be applied.
	 * @param cleanEnvironment Specifies if the system environment variables should
	 *                         be cleared or not.
	 * @param executable       The string which should be used to start a process
	 *                         via ProcessBuilder.
	 * @return The {@link ProcessContainer} which wraps the relevant streams and
	 *         processes.
	 */
	 ...
	 * @throws InterruptedException
	 */
	public static ProcessContainer invokeJavaProcess(String... arguments)
	...
	public static ProcessContainer invokeJavaProcess(Map<String, String> environment, boolean cleanEnv,
			String... arguments) throws FileNotFoundException, InterruptedException {
		/*
