 ...
 * 
 * Action which is used as predefined Action in the rule engine. Sends the
 * received email.
 */
@AnnotationAction(name = "forward email",
		description_de = "Sendet den inhalt der bekommen email weiter",
		description_en = "Forwards th received email to address")
public class TemplateActionForwardEmail extends AbtractEmailAction{
	...
	@AnnotationRuleParam(name = "text",
			description_de = "Text der an die Email angehängt werden soll.",
