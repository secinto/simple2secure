...
public abstract class ProcessorRepository extends MongoRepository<Processor> {
	public abstract List<Processor> getProcessorsByProbeId(String probeId);
	
	public abstract List<Processor> getProcessorsByGroupId(String groupId, boolean isGroupProcessor);
