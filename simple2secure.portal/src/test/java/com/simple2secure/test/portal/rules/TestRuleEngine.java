...
public class TestRuleEngine {
	...
	public void testConditionBlockedDomain()
	{
		...
		Email email1 = new Email("1", "5d4ad93028dad11740e9f4b5", 1, "subject", 
				"alice@g00gle.com", "text", "Mon Aug 19 10:00:00 CEST 2019");
		...
		TemplateCondition condition = new TemplateCondition(
				...
				new ArrayList<RuleParamArray<?>>(){{
					add(new RuleParamArray<String>(
						"domains", 
						null, 
						null,// new ArrayList<RuleParam<?>>();
						new ArrayList<String>(){{add("g00gle.com");}},
						DataType._STRING)
						);}});
		...
		try {
			Rule rule = ruleUtils.buildRuleFromTemplateRuleWithBean(ruleData, "com.simple2secure.portal.rules.conditions", "com.simple2secure.portal.rules.actions");
	...
	public void testConditionFindWordsInSubject()
	{
		...
		// email which should be checked
		Email email1 = new Email("1", "5d4ad93028dad11740e9f4b5", 1, "WON MONEY", 
				"alice@lottery.com", "text", "Mon Aug 19 10:00:00 CEST 2019");
 
		// preparing condition for blocking email address
		TemplateCondition condition = new TemplateCondition(
				"find words in subject",
				"",
				"",
				null,
				new ArrayList<RuleParamArray<?>>()
		...
		try {
			...
			// if database is null the rule has not been triggered
			assertFalse(notificationRepository.findAll() == null, "Condition \"blocked words in subject\" did not worked. No notification found.");
		} catch (ClassNotFoundException | InstantiationException | IllegalAccessException | IllegalArgumentException
				| IOException e) {
	...
	public void testConditionFindWordsInText()
	{
		...
		// email which should be checked
		Email email1 = new Email("1", "5d4ad93028dad11740e9f4b5", 1, "subject", 
				"alice@lottery.com", "You won in the lottery. Just click here ...", "Mon Aug 19 10:00:00 CEST 2019");
