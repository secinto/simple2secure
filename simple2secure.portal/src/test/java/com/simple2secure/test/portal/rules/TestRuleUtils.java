...
public class TestRuleUtils {
	...
	public void testFetchingTemplateActions() {
		...
		try {
			...
			templateActionData.forEach(action -> {
				...
				assertEquals("action description_de", action.getDescription_de(),
						"Field description_de from the Annotation \"AnnotationAction\"n is wrong");
				assertEquals("action description_en", action.getDescription_en(),
						"Field description_en from the Annotation \"AnnotationAction\"n is wrong");
				...
				RuleParamArray<?> ruleParamArray = new RuleParamArray<Integer>("arrayInt", "arrayInt description_en", "arrayInt description_de",
						null, DataType._INT);
				...
				ruleParamArray = new RuleParamArray<Double>("arrayDouble", "arrayDouble description_en", "arrayDouble description_de", null,
						DataType._DOUBLE);
				...
				ruleParamArray = new RuleParamArray<String>("arrayString", "arrayString description_en", "arrayString description_de", null,
						DataType._STRING);
	...
	public void testFetchingTemplateConditions() {
		...
		try {
			...
			templateCondtionData.forEach(condition -> {
				...
				assertEquals("action description_de", condition.getDescription_de(),
						"Field description_de from the Annotation \"AnnotationAction\"n is wrong");
				assertEquals("action description_en", condition.getDescription_en(),
						"Field description_en from the Annotation \"AnnotationAction\"n is wrong");
	...
	public void testCreatingActionObjectFromActionData() {
		...
		TemplateAction templateAction = new TemplateAction("test action", "action description_en", "action description_de", ruleParams,
				ruleParamArrays);
	...
	public void testCreatingConditionObjectFromConditionData() {
		...
		TemplateCondition templateCondition = new TemplateCondition("test condition", "action description_en", "action description_de",
