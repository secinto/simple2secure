...
public class ProbeConfiguration {
	...
	public static ObjectId probeId;
	...
	private void verifyLicense() {
		...
		boolean oldLicenseValidity = ProbeConfiguration.isLicenseValid;
		...
		if (support != null && oldLicenseValidity != isLicenseValid) {
			support.firePropertyChange("isLicenseValid", oldLicenseValidity, isLicenseValid);
		}
