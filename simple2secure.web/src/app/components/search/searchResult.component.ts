...
import { OsQueryReportDetailsComponent } from '../report/osqueryReportDetails.component';
import { NetworkReportDetailsComponent } from '../report/networkReportDetails.component';
...
export class SearchResultComponent implements OnInit {
    ...
    getSearchResults() {
        ...
        if (this.searchString) {
            const apiUrl = environment.apiSearchString.replace('{searchQuery}', this.searchString);
