...
def authenticate(app):
    """
    This function should be used only when using the pod for the first time. When all data is initialized, for all other
    cases the refreshToken will be used for accessToken renewal
    """
    ...
    if stored_license is not None and stored_license.licenseId != 'NO_ID':
        ...
        update_pod_status_license(stored_license.groupId, stored_license.licenseId)
